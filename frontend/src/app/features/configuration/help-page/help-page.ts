...
export class HelpPage {
  ...
  readonly botonesIconos: IconExplanation[] = [
    ...
    },
    {
      ...
      label: 'Eliminar',
      description:
        'Elimina un registro de forma permanente. Siempre pide confirmación antes de ejecutarse.',
    },
    {
      icon: 'visibility',
      label: 'Ver detalle',
    ...
    },
    {
      ...
      label: 'Exportar',
      description:
        'Descarga la información visible en un archivo (por ejemplo PDF o Excel) para usarla fuera del sistema.',
    },
    {
      icon: 'check',
      label: 'Guardar',
    ...
    },
    {
      ...
      label: 'Limpiar',
      description:
        'Borra los valores ingresados en los campos de búsqueda o formularios para iniciar una nueva operación.',
    },
    {
      icon: 'check_circle',
      label: 'Activar',
      description:
        'Cambia el estado de un registro a activo permitiendo nuevamente su uso dentro del sistema.',
    },
    {
      icon: 'block',
      label: 'Desactivar',
      description:
        'Cambia el estado de un registro a inactivo evitando su uso sin eliminar la información.',
    },
    {
      icon: 'arrow_upward',
      label: 'Orden ascendente',
      description:
        'Ordena la información de menor a mayor, por ejemplo de A a Z o del valor más bajo al más alto.',
    },
    {
      icon: 'arrow_downward',
      label: 'Orden descendente',
      description:
        'Ordena la información de mayor a menor, por ejemplo de Z a A o del valor más alto al más bajo.',
    },
    {
      icon: 'message',
      label: 'Ver mensaje',
      description:
        'Muestra el contenido de un mensaje, notificación o comunicación asociada a un registro.',
    },
    {
      icon: 'account_circle',
      label: 'Ver perfil',
      description:
        'Permite consultar la información detallada del perfil de un usuario o persona registrada.',
    },
    {
      icon: 'picture_as_pdf',
      label: 'Generar PDF',
      description:
        'Genera un documento en formato PDF con la información seleccionada para visualizar o compartir.',
    },
    {
      icon: 'description',
      label: 'Generar Excel',
      description:
        'Exporta la información del sistema a un archivo Excel para análisis o gestión externa.',
    },
    {
      icon: 'insert_drive_file',
      label: 'Ver archivo',
      description:
        'Permite abrir o consultar un archivo asociado a un registro dentro del sistema.',
    },
    {
      icon: 'bar_chart',
      label: 'Ver gráficos',
      description:
        'Muestra representaciones gráficas de la información para facilitar el análisis y la toma de decisiones.',
    },
    {
      icon: 'upload_file',
      label: 'Importar archivo',
      description:
        'Carga información desde un archivo externo para registrarla dentro del sistema.',
    },
  ];
  ...
  readonly formularioIconos: IconExplanation[] = [
    ...
    },
    {
      ...
      label: 'Radio button',
      description:
        'Permite seleccionar únicamente una opción entre varias alternativas disponibles.',
    },
    {
      icon: 'text_fields',
  ...
  readonly seleccionIconos: IconExplanation[] = [
    {
      ...
      description:
        'Marca uno o varios registros de la tabla para aplicarles una acción en conjunto.',
    },
    {
      icon: 'check_box_outline_blank',
      label: 'Seleccionar todo',
      description:
        'Ubicada en el encabezado de la tabla; marca o desmarca todos los registros visibles a la vez.',
    },
    {
      icon: 'toggle_on',
      label: 'Activar',
      description: 'Cambia el estado de los registros seleccionados a "activo".',
    },
    {
      icon: 'toggle_off',
      label: 'Desactivar',
      description: 'Cambia el estado de los registros seleccionados a "inactivo".',
    },
    {
      icon: 'delete_sweep',
      label: 'Eliminar seleccionados',
      description:
        'Elimina de forma permanente todos los registros marcados. Pide confirmación antes de ejecutarse.',
    },
  ];
  ...
  readonly graficosIconos: IconExplanation[] = [
    {
      ...
      description: 'Compara valores entre distintas categorías dentro de un mismo periodo.',
    },
    {
      icon: 'show_chart',
      label: 'Gráfico de líneas',
      description: 'Muestra la evolución de un dato a lo largo del tiempo.',
    },
    {
      icon: 'pie_chart',
      label: 'Gráfico circular',
      description: 'Muestra la proporción de cada categoría respecto al total.',
    },
    {
      icon: 'file_download',
      label: 'Exportar reporte',
      description:
        'Descarga el gráfico o los datos que lo componen en un archivo (PDF o Excel) para usarlos fuera del sistema.',
    },
    {
      icon: 'date_range',
      label: 'Rango de fechas',
      description: 'Define el periodo de tiempo que se quiere analizar en el reporte.',
    },
  ];
  ...
  readonly seguridadIconos: IconExplanation[] = [
    {
      icon: 'shield',
      label: 'Seguridad',
      description: 'Sección donde se gestionan las opciones de protección de tu cuenta.',
    },
    {
      icon: 'verified_user',
      label: 'Verificación en dos pasos',
      description:
        'Agrega un paso adicional de confirmación al iniciar sesión, además de la contraseña.',
    },
    {
      icon: 'devices',
      label: 'Sesiones activas',
      description:
        'Muestra los dispositivos donde tu cuenta tiene una sesión iniciada actualmente.',
    },
    {
      icon: 'history_toggle_off',
      label: 'Cerrar sesiones',
      description: 'Permite cerrar el acceso desde dispositivos que ya no reconoces o no usas.',
    },
  ];
  ...
  readonly configuracionIconos: IconExplanation[] = [
    ...
    },
    {
      ...
      label: 'Mi perfil',
      description:
        'Permite consultar y administrar la información personal, preferencias y datos de tu cuenta.',
    },
    {
      icon: 'palette',
      label: 'Cambio de tema',
      description:
        'Permite cambiar la apariencia del sistema seleccionando entre diferentes modos visuales.',
    },
  ];
